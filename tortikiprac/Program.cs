...
namespace tortikiprac
{
    internal class Program
    {
        ...
        {
            tort vibor = new tort();
            Console.WriteLine("Велком ту наша забегаловка, настройте торт по своему усмотрению");
            Console.WriteLine("---------------------------------------------------------------");
...
// Короче можно просто присваивать переменной значеие в зависимости от выбора и засунуть число выбороа в case тогда кол-во кейсов столько сколько у нас подпунктов
//И тогда можно просто в кейс засунуть сложение